...
<table width="1200" height="360" border="0" cellpadding="0" cellspacing="0" align="center">
  <tr>
    <td width="210" height="100%" valign="top"><table width="210px" height="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td valign="top" style="border:1px solid #d5d5d5; padding:5px;" height="100%"><form action="./?<?=$q?>=search" enctype="multipart/form-data" method="post">
              <table border="0" align="center" cellpadding="0" cellspacing="2">
                <tr>
                  <td width="70" height="25">Tite:</td>
        ...
        <tr>
          <td height="34" class="HeadingBG">NEW IMAGE</td>
        </tr>
        <tr>
          <td height="5"></td>
        </tr>
        ...
        <tr>
          <td height="44" align="center" style="border:1px solid #d5d5d5; padding:5px;"><a href="./?imagegallery" ">Click here to add a new image.</a> </td>
        </tr>
        <tr>
          <td background="./images/bgrad.jpg" height="5"><img src="./images/bgrad.jpg"></td>
        </tr>
    ...
    <td  height="100%" valign="top"><table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<td height="34" align="left" class="HeadingBG" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
		   <tr>
		     <td class="HeadingBG_text">IMAGE GALLERY</td>
			  <td align="right"><?
$temp = trim($_GET['sort']);
$sortBy = 'id';
$sortDir = 'asc';
...
$result = query("SELECT id, title FROM imagegallery WHERE  ".implode(' AND ', $parr)." ORDER BY $sortBy $sortDir");
$inpage = 10;
$all = $result->num_rows;
        ...
        <tr>
          <td height="100%" valign="top" style="border:1px solid #d5d5d5; padding:5px;"><table width="100%" border="0" cellspacing="2" cellpadding="0" class="leftPad">
              ...
              <tr style="background:url(./images/dots.jpg); background-repeat:repeat-x; background-position:bottom left">
                <td height="25" width="93%"><?= makeHeader('Title', 'title'); ?></td>
			...
			while(($row = $result->fetch_array(MYSQLI_NUM)) && ($cnt++ < min($inpage,$all-$i))) {
                ...
                <tr<?= $obg?$obg:$bg; ?>>
                <td  style="padding-top:6px; padding-bottom:5px;"><?= $row[1]; ?></td>

                <td  align="center" valign="top" style="padding-top:6px;color:b5b5b5">
              <a href="./?<?=$q?>=del&del=<?= $row[0]; ?>" onClick="return confirm('Are you sure you want to delete \'<?= addslashes($row[1]); ?>\' from the gallery list?')">Del</a>
                 </td>
              </tr>
              <? }}else {?>
            <tr>
