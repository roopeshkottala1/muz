...
<body>
  ...
  <div class="container">
    ...
    <!-- Jumbotron Header -->
    <header class="jumbotron1 hero-spacer">

        <?
        $result = query("select content from pages where id = '5' limit 1");
    ...
    <div class="row">
      <div class="col-lg-12">
          <?
          $result = query("select content from pages where id = '4' limit 1");
          list($content) = $result->fetch_array();
          echo $content;
          ?>
      </div>
